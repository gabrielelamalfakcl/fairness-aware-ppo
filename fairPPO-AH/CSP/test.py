...
parser.add_argument("--wandb_run_name", type=str, default=None, help="Name for WandB run")
parser.add_argument("--weights_dir", type=str, required=True, help="Directory containing saved weights")
...
def test_agents(ppo_agent_non_sensitive, ppo_agent_sensitive, config):
    ...
    results_dir = os.path.join(os.getcwd(), "fairness_results_folder_csp")
