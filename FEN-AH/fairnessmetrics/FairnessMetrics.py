...
class CumulativeMetrics:
    ...
    def demographic_parity(self, total_rewards_non_sensitive: float, total_rewards_sensitive: float):
        """
    ...
    def conditional_statistical_parity(self, total_rewards_non_sensitive_G1: torch.Tensor, total_rewards_sensitive_G1: torch.Tensor,
        total_rewards_non_sensitive_G2: torch.Tensor, total_rewards_sensitive_G2: torch.Tensor):
        """
...
class StateValueMetrics:
    ...
    def demographic_parity(self, state_values_non_sensitive: torch.Tensor, state_values_sensitive: torch.Tensor):
        """
    ...
    def conditional_statistical_parity(self, 
        ...
        # Convert floats to tensors (if needed)
